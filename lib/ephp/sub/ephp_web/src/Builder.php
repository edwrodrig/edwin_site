...
static function __callStatic($name, $args) {
  if ( !self::has_started() ) throw \Exception("Error: Build process not initialized");
...
private function init() {
  ...
  if ( empty(\ephp\Format::$current_lang) ) { printf("Error: Not language set!! You must set a language like = es\n"); throw new \Exception("Error: Not language set!! You must set a language like = es\n"); }
